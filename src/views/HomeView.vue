  ...
  <main class="bg-zinc-800" >
    <div class="">
        <div class="b-zinc-500 flex">
          ...
          <div class="basis-1/2 pt-16 2xl:pt-64 xl:pt-48 lg:pt-36 md:pt-28  sm: pt-20  pt-5">
            ...
            <button class="homeButtomProjekt text-center p-2 xs:p-4 lg:p-6 lg:mt-10 bg-sky-900 ">Se projekter</button>
          </div>
          </div>
        ...
        <div class=" right-0 h-80">
          <div class="flex flex-row xs:flex-col sm:flex-row ">
           <div class="basis-1/12 xs:basis-2 sm:basis-36">
            1
          </div>

            <div class="basis-1/2 bg-orange-600">
              2
              <h1 class="text-5xl">
                Alberte
              </h1>
              ...
              <button class="homeButtomProjekt text-center p-2 xs:p-4 lg:p-6 lg:mt-10 bg-sky-900 ">Om Mig</button>
            </div>
