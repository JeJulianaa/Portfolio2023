          ...
          <div class="w-full sections flex flex-wrap w-5/6 justify-end ">
            <div class="w-full lg:w-[60%] pb-2  lg: py-5" >
              ...
              <div class="border-4 border-[#2E2E30] rounded-lg text-center pt-[11%] h-full">
                ...
                <p>
                  Om det er på en arbejdesplads eller en kunde vil du altid opleve at jeg er en glad og imødekommmende person
                   som arbejder ambisøst på sine projekter.
                   Jeg er går ind til alle projekter med en passion på 110%, Jeg aldrig oplevet at få et projekt jeg synes var kedeligt
                    da jeg synes det er sjovt og spændende at få udfordringer og lære nyt viden.
                   Hvis du gerne vil vide mere omkring mig så du velkommen til at se mit video CV hvor jeg 
                   bla. kommer ind over mine færdigheder, uddannelse, jobs og mig som person. 
                   ellers hvis du 
                 ...
                 <p>
                   ...
                   <h1>En holdspiller</h1>
                    <p> 
                      ...
                      jeg elsker at samle alle trådende sammen så det færdig projekt for sin helhed. 
                      når jeg arbejder i et team sørger jeg for at komunnikere hele tiden, og arbejde som et team så
                      alle føler sig tilpas i sammenarbejdet. Jeg har fra tidligere jobs både erfaring med team arbejde 
