        ...
        <h1>Om Mig</h1>
          ...
          <div class="w-full flex flex-wrap">
              ...
              <div class="w-full lg:w-full flex flex-wrap justify-center  2xl:flex-row md:flex-col w-full lg:flex-row ">
                    ...
                    <div class="childTwo  w-[30%] pl-2 py-2 pt-4 rounded-lg xs:w-full sm:w-full md:w-full lg:w-[30%]">
                      <div class="w-full h-full childTwo rounded-lg overflow-hidden">
                        <img class="w-full h-full object-cover" src="@/assets/billeder/alberte-billede-home.jpg" alt="">
                      </div>
                    </div>
